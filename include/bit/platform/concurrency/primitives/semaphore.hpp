 ...
 */
#ifndef BIT_PLATFORM_CONCURRENCY_PRIMITIVES_SEMAPHORE_HPP
#define BIT_PLATFORM_CONCURRENCY_PRIMITIVES_SEMAPHORE_HPP
...
#endif /* BIT_PLATFORM_CONCURRENCY_PRIMITIVES_SEMAPHORE_HPP */
