 ...
 */
#ifndef BIT_PLATFORM_CONCURRENCY_PRIMITIVES_NULL_MUTEX_HPP
#define BIT_PLATFORM_CONCURRENCY_PRIMITIVES_NULL_MUTEX_HPP
...
#endif /* BIT_PLATFORM_CONCURRENCY_PRIMITIVES_NULL_MUTEX_HPP */
