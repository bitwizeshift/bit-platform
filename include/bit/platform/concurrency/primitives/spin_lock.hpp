 ...
 */
#ifndef BIT_PLATFORM_CONCURRENCY_PRIMITIVES_SPIN_LOCK_HPP
#define BIT_PLATFORM_CONCURRENCY_PRIMITIVES_SPIN_LOCK_HPP
...
#endif /* BIT_PLATFORM_CONCURRENCY_PRIMITIVES_SPIN_LOCK_HPP */
