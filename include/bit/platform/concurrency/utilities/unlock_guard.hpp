 ...
 */
#ifndef BIT_PLATFORM_CONCURRENCY_UTILITIES_UNLOCK_GUARD_HPP
#define BIT_PLATFORM_CONCURRENCY_UTILITIES_UNLOCK_GUARD_HPP
...
#endif /* BIT_PLATFORM_CONCURRENCY_UTILITIES_UNLOCK_GUARD_HPP */
